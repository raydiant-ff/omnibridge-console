...
export function PickLineItems({ lineItems, billingFrequency, onChange, onNext, onBack }: Props) {
                    ...
                    li.overrideUnitAmount < li.unitAmount ? (
                      <div className="ml-auto flex items-center gap-1.5">
                        ...
                        <span className="font-mono text-xs text-green-600">
                          {formatCurrency(toDisplay(effectiveUnit(li), li.interval) * li.quantity, li.currency)}
                        </span>
                      </div>
                    ) : (
                      <div className="ml-auto flex items-center gap-1.5">
